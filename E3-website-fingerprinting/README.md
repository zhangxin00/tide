...
3.a  Run `python3 record_data.py --num_runs 40 --browser safari --trace_length 5 --sites_list alexa10 --out_directory safari-experiment' to record the side channel traces.
...
# Expected results
When running step 3, the top-1 accuracy is higher than random guess (10% in our example that contains 10 websites).
